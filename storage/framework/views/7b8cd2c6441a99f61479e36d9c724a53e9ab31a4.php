...
<?php $__env->startSection('page-content'); ?>
	<form class="layui-form" method="POST">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="lang" class="" lay-filter="lang" lay-verify="required">
						<?php $__currentLoopData = $langList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang=>$lt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				        <option value="<?php echo e($lang); ?>" <?php echo e(isset($news['lang']) && $news['lang'] == $lang ? 'selected' : ''); ?>><?php echo e($lt); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				    </select>
				</div>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input class="layui-input" placeholder="请输入跳转连接" type="text" name="href" value="<?php if(isset( $news['href'] )): ?><?php echo e($news['href']); ?><?php endif; ?>">
			</div>
		</div>
