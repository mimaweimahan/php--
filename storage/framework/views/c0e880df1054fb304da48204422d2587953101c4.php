                ...
                <div class="layui-tab-content">
                    ...
                    <!-- <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="currency_to_usdt_bmb_fee" autocomplete="off"
                                       class="layui-input"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="currency_to_bmb_usdt_fee" autocomplete="off"
                                       class="layui-input"
    ...
    <script type="text/javascript">
        layui.use(['element', 'form', 'upload', 'layer', 'laydate'], function () {
            ...
            $('#btnSaveApp').click(()=>{
                ...
                xhr.onerror = (res)=>{layer.closeAll('loading'); layer.msg('上传失败');}; //请求失败
                xhr.upload.onprogress = (res)=>{console.log(res)};//【上传进度调用方法实现】
