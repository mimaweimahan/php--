        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">账户资产类型（USDT四个全开，其余只开闪兑交易）</label>
                ...
                <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="contract_address"  autocomplete="off" placeholder="充币地址" class="layui-input" value="<?php echo e($result->contract_address); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">二维码图片s</label>
                        <div class="layui-input-block">
                            <input type="text" name="get_address"  autocomplete="off" placeholder="二维码图片地址（一般情况下无需填写）" class="layui-input" value="<?php echo e($result->get_address); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item" style="display:none;">
