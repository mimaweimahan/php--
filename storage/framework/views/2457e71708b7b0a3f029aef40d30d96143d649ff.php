        ...
        window.onload = function() {
            ...
            layui.use(['element', 'form', 'layer', 'table'], function () {
                ...
                form.on('submit(mobile_search)',function(obj){
                    ...
                    tbRend("<?php echo e(url('admin/wealth/trade/lists')); ?>?id="+id+"&account_name="+account_name+"&product="+product+"&status="+status);
                    return false;
                });
                ...
                tbRend("<?php echo e(url('/admin/wealth/trade/lists')); ?>");
