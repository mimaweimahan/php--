            ...
            <script>
                window.onload = function() {
                    ...
                    layui.use(['element', 'layer', 'table'], function () {
                        ...
                        tbRend("<?php echo e(url('/admin/bztl/product/list')); ?>");
                        //监听工具条
                        table.on('tool(wealthlist)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                            ...
                            if (layEvent === 'delete') { //删除
                                ...
                                layer_show('修改产品','/admin/bztl/product/edit?id='+data.id);
                            }
                        });
                        ...
                        table.on('toolbar(wealthlist)',function (obj){
                            switch (obj.event){
                                case 'addProduct':
                                    layer_show('增加产品','/admin/bztl/product/add');
                                    break;
                            };
                        });
                    });
