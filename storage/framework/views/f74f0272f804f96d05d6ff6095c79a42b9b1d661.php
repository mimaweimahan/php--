...
<!-- 开始菜单 -->
<div class="winui-start sp layui-hide" style="width: auto;">
    <!-- 左边设置 -->
    ...
    <div class="winui-start-center">
        <div class="layui-side-scroll" style="margin: 5px;">
            <ul class="winui-menu layui-nav layui-nav-tree" lay-filter="winuimenu"></ul>
        </div>
    </div>
    <!-- 右边磁贴 -->
    <div class="winui-start-right" style="display: none;">
...
<div class="winui-taskbar">
    ...
    <div class="winui-taskbar-time" style="right: 5px;"></div>
    <!-- 控制中心 -->
    <div class="winui-taskbar-console sp" style="display: none!important;">
