    ...
    <form class="layui-form" action="">
        <div class="layui-form-item" style="display: none;">
            ...
            <div class="layui-input-inline">
                <input type="text" name="huobi_currency" lay-verify="" autocomplete="off" placeholder="" class="layui-input" value="<?php if(!empty($result->huobi_currency)): ?><?php echo e($result->huobi_currency); ?><?php endif; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">每次成交数量下限</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">每次成交数量上限</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">精度（小数点后位数）</label>
            <div class="layui-input-inline">
