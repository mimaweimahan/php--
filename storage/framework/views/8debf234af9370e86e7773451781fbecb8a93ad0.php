            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                    ...
                    <!-- <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">其他客服</label>
                            <div class="layui-input-block">
                                <input type="text" name="other_service_url" autocomplete="off" class="layui-input"
                                       value="<?php if(isset($setting['other_service_url'])): ?><?php echo e($setting['other_service_url'] ?? ''); ?><?php endif; ?>">
                            </div>
                        </div>
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">是否固定价格(1固定，其他不固定)</label>
                            <div class="layui-input-block">
                                <input type="text" name="iepn_price_fixed" autocomplete="off"
                                       class="layui-input"
                                       value="<?php if(isset($setting['iepn_price_fixed'])): ?><?php echo e($setting['iepn_price_fixed'] ?? ''); ?><?php endif; ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                           ...
                           <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea type="text" style="height:100px;" name="iepn_dsp" autocomplete="off"
                                       class="layui-input"><?php if(isset($setting['iepn_dsp'])): ?><?php echo e($setting['iepn_dsp'] ?? ''); ?><?php endif; ?></textarea>
                            </div>
                        </div>
                        
                         <div class="layui-form-item">
                            <label class="layui-form-label">最低限购数量</label>
                            <div class="layui-input-block">
                                <input type="text" name="iepn_min_num" autocomplete="off"
                                       class="layui-input"
                                       value="<?php if(isset($setting['iepn_min_num'])): ?><?php echo e($setting['iepn_min_num'] ?? ''); ?><?php endif; ?>">
                            </div>
                        </div>
