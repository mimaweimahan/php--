    ...
    <form class="layui-form" method="POST">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input class="layui-input itime" name="itime"  lay-verify="required" placeholder="请选择时间" type="text" value="<?php echo e(date('Y-m-d H:i:s')); ?>">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input class="layui-input newsName" name="close" lay-verify="required" placeholder="收仓价格" type="text" value="<?php if(isset($news['title'])): ?><?php echo e($news['title']); ?><?php endif; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">基础币种</label>
            <div class="layui-input-block">
                <input class="layui-input newsName" name="base" lay-verify="required" placeholder="基础币种" type="text" value="<?php if(isset($news['title'])): ?><?php echo e($news['title']); ?><?php endif; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">引用币种</label>
            <div class="layui-input-block">
                <input class="layui-input newsName" name="target" lay-verify="required" placeholder="引用币种" type="text" value="<?php if(isset($news['title'])): ?><?php echo e($news['title']); ?><?php endif; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
