...
<div class="layui-form">
    <div class="layui-item">
        ...
        <div class="layui-btn-group">
            <button class="layui-btn layui-btn-primary" onclick="javascrtpt:window.location.href='<?php echo e(url('/admin/user/csv')); ?>'"> <i class="layui-icon  layui-icon-export"></i></button>
