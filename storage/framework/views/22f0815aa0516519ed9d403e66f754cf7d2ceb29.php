...
<?php $__env->startSection('page-content'); ?>
    ...
    <div class="layui-form">
        <div class="layui-collapse">
            ...
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">现货交易参数</h2>
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">交易数量范围</label>
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 60px;">
                                <input type="text" class="layui-input" name="change_min_share" placeholder="最小值" value="<?php echo e($currency_match->change_min_share ?? 1.00); ?>" >
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 60px;">
                                <input type="text" class="layui-input" name="change_max_share" placeholder="最大值,为0表示不限制" value="<?php echo e($currency_match->change_max_share ?? 0.00); ?>" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="change_trade_fee" placeholder="现货交易手费续" value="<?php echo e($currency_match->change_trade_fee ?? 0.00); ?>" >
                            </div>
                            <div class="layui-form-mid">%</div>
                        </div>
                    </div>
