            ...
            <div class="layui-card-body">
                <div class="layui-form" lay-filter="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <?php if(isset($d['username'])): ?>
                                <input type="text" name="username" readonly value="<?php echo e($d['username']); ?>"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script type="text/html" template>
                                <input type="text" name="btc_address" value="<?php echo e(isset($d['btc_address']) ? $d['btc_address'] : ''); ?>"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script type="text/html" template>
                                <input type="text" name="usdt_address" value="<?php echo e(isset($d['usdt_address']) ? $d['usdt_address'] : ''); ?>"
