...
<?php $__env->startSection('page-content'); ?>
                ...
                <div class="layui-input-inline" style="width:100px;">
                    <select name="product" id="product">
                        ...
                        <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value->id); ?>" class="ww"><?php echo e($value->wealth_name); ?></option>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a style="display:none;" class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delete">{{ d.status == 1 ? '下架' : '上架' }}</a>
    </script>
<?php $__env->stopSection(); ?>
        ...
        window.onload = function() {
            ...
            layui.use(['element', 'form', 'layer', 'table'], function () {
                ...
                form.on('submit(mobile_search)',function(obj){
                    ...
                    tbRend("<?php echo e(url('admin/bztl/trade/lists')); ?>?id="+id+"&account_name="+account_name+"&product="+product+"&status="+status);
                    return false;
                });
                //监听工具条
                table.on('tool(list)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if(layEvent === 'edit'){
                        ...
                        layer.confirm('真的要取消订单吗？', function (index) {
                            $.ajax({
                                url: '/agent/order/bztlSell',
                                type: 'get',
                                dataType: 'json',
                ...
                tbRend("<?php echo e(url('/admin/bztl/trade/lists')); ?>");
