...
<?php $__env->startSection('page-content'); ?>
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加计划点','<?php echo e(url('admin/robot/sche_add')); ?>?rid=<?php echo e($rid); ?>')">添加计划点</button>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: '<?php echo e(url('admin/robot/sche_data')); ?>?rid=<?php echo e($rid); ?>' //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
            ...
            table.on('tool(test)', function(obj) {
                ...
                if (obj.event === 'del') {
                    layer.confirm('真的删除行么', function (index) {
                        $.ajax({
                            url: '<?php echo e(url('admin/robot/sche_delete')); ?>',
                            type: 'post',
                            dataType: 'json',
                            data: {id: data.id},
                            success: function (res) {
                    ...
                    layer_show('编辑拐点', '<?php echo e(url('admin/robot/sche_add')); ?>?id=' + data.id);
                ...
                {
                    layer_show('预设的行情拐点', '<?php echo e(url('admin/robot/sche')); ?>?id=' + data.id);
                }
            });
