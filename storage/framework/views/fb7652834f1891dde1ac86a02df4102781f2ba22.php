...
<?php $__env->startSection('page-content'); ?>
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea type="text" name="user_remark" autocomplete="off" style="height:100px" placeholder="" class="layui-input" ><?php if(!empty($result->user_remark)): ?><?php echo e($result->user_remark); ?><?php endif; ?></textarea>
            </div>
        </div>
