            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select id="currency" name="currency" class="layui-input">
                        <?php $__currentLoopData = $data['currencys']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($currency['currency_name']); ?>"><?php echo e($currency['currency_name']); ?></option>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        layui.use(['element','laydate', 'form', 'table', 'layedit', 'laypage', 'layer'], function () {
            ...
            table.render({
                elem: '#demo'
                , url: "<?php echo e(url('admin/myquotation/list')); ?>" //数据接口
                , page: true //开启分页
                , id: 'mobileSearch'
                ,limit:20
