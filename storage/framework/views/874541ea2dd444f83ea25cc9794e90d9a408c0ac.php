    ...
    <div class="layui-side layui-bg-black kit-side">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                <?php if(in_array("user_index",$admin_role_data)): ?>
                ...
                <?php endif; ?>
                <?php if(in_array("tran_index",$admin_role_data)): ?>
                <li class="layui-nav-item layui-nav-itemed">
                ...
                <?php endif; ?>
                <?php if(in_array("set_bonus",$admin_role_data) || in_array("set_base",$admin_role_data)): ?>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;"><i class="fa fa-plug" aria-hidden="true"></i><span> 奖金设置</span></a>
                    <dl class="layui-nav-child">
                        <?php if(in_array("set_bonus",$admin_role_data)): ?>
                        ...
                        <?php endif; ?>
                        <?php if(in_array("set_base",$admin_role_data)): ?>
                ...
                <?php endif; ?>
                <?php if(in_array("account_index",$admin_role_data)): ?>
                <li class="layui-nav-item layui-nav-itemed">
                ...
                <?php endif; ?>
                <?php if(in_array("news_index",$admin_role_data)): ?>
                <li class="layui-nav-item layui-nav-itemed">
                ...
                <?php endif; ?>
                <?php if(in_array("manager_index",$admin_role_data)): ?>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;"><i class="fa fa-plug" aria-hidden="true"></i><span> 管理员权限</span></a>
                    <dl class="layui-nav-child">
                        <?php if(in_array("manager_index",$admin_role_data) || in_array("manager_roles",$admin_role_data)): ?>
                        ...
                        <?php endif; ?>
                        <?php if(in_array("manager_roles",$admin_role_data)): ?>
