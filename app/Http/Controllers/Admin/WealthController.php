...
class WealthController extends Controller
{
    public function index(){
        return view('admin.wealth.index');
    }


    public function wealthLists(Request $request){
        $limit = $request->get('limit', 10);
        $result = new WealthProduct();
    ...
    public function add(Request $request){
        ...
        return view('admin.wealth.add',['currencies'=>$currencies]);
    }
    ...
    public function doadd(Request $request){
        ...
        $objWealthProduct = new WealthProduct();
    ...
    public function edit(Request $request){
        ...
        return view("admin.wealth.edit",['result'=>$result,'currencies'=>$currencies]);
    }
    ...
    public function del(Request $request){
        ...
        if($wealth->status == WealthProduct::STATUS0){
            $wealth->status = WealthProduct::STATUS1;
        }else{
            $wealth->status = WealthProduct::STATUS0;
        }
