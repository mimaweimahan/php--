...
class TransactionIn extends Model
{
     ...
     * @return void
     */
    public static function transaction($out, $num, $user, $legal_id, $currency_id, $match = null)
    {
        ...
        $fee = bc_mul($cny, ($match->change_trade_fee * 0.01), 5);
        $data_wallet1 = [
            'balance_type' => 2,
        ...
        $to_legal->change_balance = bc_sub($to_legal->change_balance, $cny + $fee, 5);
        $to_legal->save();
        ...
        $data_wallet11 = [
            ...
            'lock_type' => 0,
            'create_time' => time(),
            'before' => $to_legal->change_balance - $cny,
            'change' => -$fee,
            'after' => bc_sub($to_legal->change_balance - $cny, $fee, 5),
        ];
        AccountLog::insertLog([
            'user_id' => $user->id,
            'value' => -$fee,
