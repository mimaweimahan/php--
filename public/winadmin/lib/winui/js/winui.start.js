    ...
    Menu.prototype.render = function (callback) {
        ...
        $(this.data).each(function (index, item) {
            var id = (item.id == '' || item.id == undefined) ? '' : 'win-id="' + item.id + '"',
                ...
                icon = (item.icon.indexOf('fa-') != -1 && item.icon.indexOf('.') == -1) ? '<i class="fa test2 ' + item.icon + ' fa-fw"></i>' : '<img src="' + item.icon + '" />';
            ...
            if (item.childs) {
                ...
                $(item.childs).each(function (cIndex, cItem) {
                    var cId = (cItem.id == '' || cItem.id == undefined) ? '' : 'win-id="' + cItem.id + '"',
                        ...
                        cicon = (cItem.icon.indexOf('fa-') != -1 && cItem.icon.indexOf('.') == -1) ? '<i class="fa fatest3 ' + cItem.icon + ' fa-fw"></i>' : '<img src="' + cItem.icon + '" />';;
