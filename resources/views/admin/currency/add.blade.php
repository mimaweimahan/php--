            ...
            <div class="layui-tab-content">
                ...
                <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="contract_address"  autocomplete="off" placeholder="充币地址" class="layui-input" value="{{$result->contract_address}}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">二维码图片s</label>
                        <div class="layui-input-block">
                            <input type="text" name="get_address"  autocomplete="off" placeholder="二维码图片地址（一般情况下无需填写）" class="layui-input" value="{{$result->get_address}}">
                        </div>
                    </div>
                    <div class="layui-form-item" style="display:none;">
