            ...
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 60px;">
                                <input type="text" class="layui-input" name="change_min_share" placeholder="最小值" value="{{ $currency_match->change_min_share ?? 1.00 }}" >
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 60px;">
                                <input type="text" class="layui-input" name="change_max_share" placeholder="最大值,为0表示不限制" value="{{ $currency_match->change_max_share ?? 0.00 }}" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="change_trade_fee" placeholder="现货交易手费续" value="{{ $currency_match->change_trade_fee ?? 0.00 }}" >
                            </div>
                            <div class="layui-form-mid">%</div>
                        </div>
                    </div>
