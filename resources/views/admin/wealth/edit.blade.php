    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="display: flex">
                <input type="text" style="width: 100px" name="min_daily_return_rate" autocomplete="off" placeholder="收益金额" class="layui-input" value="{{$result->min_daily_return_rate}}">
                <span style="font-size: 25px; line-height: 40px; margin-left: 10px;margin-right: 10px;display:none;"> - </span>
                <input type="text" style="width: 100px;display:none;" name="max_daily_return_rate" autocomplete="off" placeholder="最大收益率" class="layui-input" value="{{$result->max_daily_return_rate}}">
    ...
    <script>
        ...
        layui.use(['form','laydate'],function () {
            ...
            form.on('submit(edit)', function(data){
                var data = data.field;
                $.ajax({
                    url:'{{url('admin/wealth/product/edit')}}'
                    ,type:'post'
                    ,dataType:'json'
                    ,data : data
