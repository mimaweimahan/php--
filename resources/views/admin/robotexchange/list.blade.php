...
@section('page-content')
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        ...
        <button class="layui-btn layui-btn-normal layui-btn-radius"
                onclick="layer_show('添加机器人','{{url('admin/robote/add')}}')">添加机器人
        </button>
...
@section('scripts')
    <script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            table.render({
                elem: '#demo'
                , url: '{{url('admin/robote/list_data')}}' //数据接口
                , page: true //开启分页
                , id: 'mobileSearch'
                , cols: [[ //表头
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    layer_show('编辑机器人', '{{url('admin/robote/add')}}?id=' + data.id);
                    ...
                    layer_show('预设的行情拐点', '{{url('admin/robote/sche')}}?rid=' + data.id);
                }
            });
