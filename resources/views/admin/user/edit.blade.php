...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea type="text" name="user_remark" autocomplete="off" style="height:100px" placeholder="" class="layui-input" >@if(!empty($result->user_remark)){{$result->user_remark}}@endif</textarea>
            </div>
        </div>
