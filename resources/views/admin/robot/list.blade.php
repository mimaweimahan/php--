...
@section('page-content')
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        <button class="layui-btn layui-btn-normal layui-btn-radius" onclick="layer_show('添加更新器','{{url('admin/robot/add')}}')">添加更新器</button>
        ...
        layui.use(['table','form'], function(){
            ...
            table.on('tool(test)', function(obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    layer_show('编辑更新器', '{{url('admin/robot/add')}}?id=' + data.id);
