    ...
    <form class="layui-form" action="">
        <div class="layui-form-item" style="display: none;">
            ...
            <div class="layui-input-inline">
                <input type="text" name="huobi_currency" lay-verify="" autocomplete="off" placeholder="" class="layui-input" value="@if(!empty($result->huobi_currency)){{$result->huobi_currency}}@endif">
            </div>
        </div>
