                ...
                window.onload = function() {
                    ...
                    layui.use(['element', 'form', 'layer', 'table'], function () {
                        ...
                        form.on('submit(mobile_search)',function(obj){
                            ...
                            tbRend("{{url('/admin/user/hreal_list')}}?account="+account+"&review_status_s="+review_status_s);
                            return false;
                        });
                        function tbRend(url) {
                            table.render({
                        ...
                        tbRend("{{url('/admin/user/hreal_list')}}");
                        ...
                        table.on('tool(userlist)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                            ...
                            if (layEvent === 'delete') { //删除
                                ...
                                layer_show('认证详情','{{url('admin/user/hreal_info')}}?id='+data.id);
                            }
                        });
                    });
                }
