                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="other_service_url" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['other_service_url'])){{$setting['other_service_url'] ?? ''}}@endif">
                            </div>
                        </div>
{{--                        <div class="layui-form-item">--}}
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="iepn_price_fixed" autocomplete="off"
                                       class="layui-input"
                                       value="@if(isset($setting['iepn_price_fixed'])){{$setting['iepn_price_fixed'] ?? ''}}@endif">
                            </div>
                        </div>
                           ...
                           <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea type="text" style="height:100px;" name="iepn_dsp" autocomplete="off"
                                       class="layui-input">@if(isset($setting['iepn_dsp'])){{$setting['iepn_dsp'] ?? ''}}@endif</textarea>
                            </div>
                        </div>
                         ...
                         <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="iepn_min_num" autocomplete="off"
                                       class="layui-input"
                                       value="@if(isset($setting['iepn_min_num'])){{$setting['iepn_min_num'] ?? ''}}@endif">
                            </div>
                        </div>
